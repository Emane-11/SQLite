...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # 2. See how much total foreign currency we can buy
    total_foreign_currency = budget / actual_rate
    
    # 3. Find out how many WHOLE bills we can get
    number_of_bills = total_foreign_currency // denomination
    
    # 4. Multiply by the denomination to get the total VALUE of those bills
